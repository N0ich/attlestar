...
<?php
	if ($_POST['login'] && $_POST['password'] && $_POST['password2'] && $_POST['mail']) {
...
<div class="content">
	<form class="inscription" method="POST">
		<h3>S'inscrire</h3>
		<input required type="text" name="login" placeholder="Identifiant" <?php if ($_POST['login']) { echo "value='".$_POST['login']."'"; } ?>/><br>
		...
		<input required type="email" placeholder="Mail" name="mail" <?php if ($_POST['mail']) { echo "value='".$_POST['mail']."'"; }?>><br>
